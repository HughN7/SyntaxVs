...
<footer class="footer footer-center p-10 bg-primary text-primary-content">
    <div>
        ...
        <br>
        <p class="font-bold">So what's the difference between using this vs having two tabs side by side?</p>
        <p>Nothing really, It's just a little more convenient, and they say convenience goes a long way.</p>
    </div> 
    <!--div>
